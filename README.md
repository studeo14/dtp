...
# How to use
This project takes a `.project` file generated by cas2text.
...
### 1) Create a project
You can create a project from `cas2text`.
...
### In Point Options
These options tell the program where to start. These are mutually exclusive options.
#### -m, --mappings
